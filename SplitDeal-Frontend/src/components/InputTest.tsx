        ...
        <div className="shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
          ...
          <div className="flex justify-center -space-x-3">
            ...
            <span className="inline-flex items-center justify-center size-8 rounded-full ring-2 ring-white bg-gray-800">
              <span className="text-xs font-medium text-white uppercase">7k+</span>
            </span>
          </div>
          {/* End Avatar Group */}
        </div>
      ...
      <form>
        <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-100">
          <div className="w-full pb-2 sm:pb-0">
            ...
            <input type="text" id="hs-hero-name-1" className="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Your name" />
          </div>
          <div className="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s w-full">
            ...
            <input type="email" id="hs-hero-email-1" className="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Your name" />
          </div>
